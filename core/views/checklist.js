...
window.CHECKLIST_CONFIG = Object.freeze({
  apiUrl: "https://script.google.com/macros/s/AKfycbyevHY0rs8Y5NHJ3X0bzM8tRZkcfuObSKiuZunZm5YMruySqk-7O_2HXcuUigZTyvUw/exec",
...
(() => {
  ...
  async function api(action, payload={}, options={}) {
    ...
    const request=(async()=>{const controller = new AbortController(); const timeout = setTimeout(()=>controller.abort(),60000);
      try {
        ...
        result=window.SAHMT_CHECKLIST_CONTRACT(result,action,payload);
  ...
  if (false)navigator.serviceWorker.register('./sw.js',{scope:'./'}).catch(()=>{});
})();
