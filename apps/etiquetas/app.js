const CONFIG = {
  ...
  guideAspectRatio: 4,
  defaultScriptUrl: "https://script.google.com/macros/s/AKfycbvjEcdI9UV8SFAAAxZx94qqMcNx-eEVLeRAoCnht4XcNloYnBPlTm76VdLfuYTrvc1uA/exec",
  maxSearchResults: 60,
};
...
async function registerServiceWorker() {
  ...
  try {
    await navigator.serviceWorker.register("./sw.js?v=20260902-5", { updateViaCache: "none" });
  } catch (error) {
