...
const FILES = ['./','./index.html','./styles.css','./premium-icons.css','./app.js','./config.js','./manifest.webmanifest','./icons/icon.svg','./vendor/zxing.min.js','./assets/carrinho-anestesia.png'];
