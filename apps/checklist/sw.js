const CACHE = 'sahmt-checklist-v33';
const FILES = ['./','./index.html','./styles.css','./premium-icons.css','./report-layout.css','./app.js','./config.js','./manifest.webmanifest','./icons/icon.svg','./assets/carrinho-anestesia-checklist.png','./vendor/zxing.min.js'];
